...
<template>
    <div class="consult-pay-page" v-if="payInfo && patient">
        ...
        <van-submit-bar button-type="primary" @click="submit" :price="payInfo.actualPayment * 100" button-text="立即支付"
            text-align="left" :loading="loading" />
        <cp-pay-sheet v-model:show="show" :order-id="orderId" :actual-payment="payInfo.actualPayment" :onClose="onClose"
